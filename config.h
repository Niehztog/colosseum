...
//
// R-ENG-1  USE_NEW_GAME_API is on, so the library targets GAME_API_VERSION_NEW
//          (3302) with gclient_new_t / pmove_new_t, and MAX_STATS is 64
//          (MAX_STATS_NEW) rather than 32 -- which R-OSP-7 clause 6 depends on.
