...
static void bq2_brain_duck_down(edict_t *self)
{
    if (self->monsterinfo.aiflags & AI_DUCKED)
        return;
...
static void bq2_brain_duck_hold(edict_t *self)
{
...
static void bq2_brain_duck_up(edict_t *self)
{
    self->monsterinfo.aiflags &= ~AI_DUCKED;
    self->maxs[2] += 32;
...
static const mframe_t bq2_brain_frames_duck[] = {
    { ai_move,    0,  NULL },
    { ai_move,    -2, bq2_brain_duck_down },
    { ai_move,    17, bq2_brain_duck_hold },
    { ai_move,    -3, NULL },
    { ai_move,    -1, bq2_brain_duck_up },
    { ai_move,    -5, NULL },
    { ai_move,    -6, NULL },
    { ai_move,    -6, NULL }
};

const mmove_t bq2_brain_move_duck = {FRAME_duck01, FRAME_duck08, bq2_brain_frames_duck, brain_run};

void bq2_brain_dodge(edict_t *self, edict_t *attacker, float eta, trace_t *tr)
{
    if (random() > 0.25f)
        return;
    ...
    self->monsterinfo.currentmove = &bq2_brain_move_duck;
}
...
// PMM
    ...
    if (self->content_flavour & CONTENT_ROGUE) {
        ...
        self->monsterinfo.dodge = bq2_brain_dodge;
    }
