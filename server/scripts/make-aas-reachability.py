...
# it -- os.environ.get evaluates its default eagerly, so the other order raises
# NameError before the first map is ever loaded.
BUILD = os.environ.get('BUILD') or sys.exit(
    'set BUILD to the directory holding q2proded.exe, e.g. '
    'BUILD=/mnt/c/Users/<you>/q2pro/builddir-win32')
